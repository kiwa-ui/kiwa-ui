...
<html lang="en">
  <head>
    ...
    <title>Your Hono UI license key</title>
  </head>
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:12px;padding:40px;">
            <tr>
              <td>
                <h1 style="margin:0 0 16px 0;font-size:22px;line-height:1.3;font-weight:600;">Thanks for picking up Hono UI Pro Blocks</h1>
          ...
          <p style="margin:20px 0 0 0;font-size:12px;color:#999;">Tossell Web Solutions Limited · honoui.com</p>
        </td>
      </tr>
    </table>
  </body>
...
export function renderWelcomeEmailText({ licenseKey, orderId }: WelcomeEmailParams): string {
  return `Thanks for picking up Hono UI Pro Blocks.
